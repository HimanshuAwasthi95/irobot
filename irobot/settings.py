"""
Django settings for irobot project.
...
SECRET_KEY = 'r06ts)v2_@esdwtm=*xk9gn8oixqu-0yp)b!u(a26-)pop@w(g'
...
WSGI_APPLICATION = 'irobot.wsgi.application'
